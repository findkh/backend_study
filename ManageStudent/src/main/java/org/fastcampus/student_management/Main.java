...
import org.fastcampus.student_management.repo.CourseCommandRepoistoryImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CourseCommandRepoistoryImpl courseCommandRepoistory = new CourseCommandRepoistoryImpl();
        CourseJdbcCommandRepository jdbcCommandRepository = new CourseJdbcCommandRepository();

        StudentService studentService = new StudentService(studentRepository);
        CourseService courseService = new CourseService(courseCommandRepoistory,
                jdbcCommandRepository,
                studentRepository);
